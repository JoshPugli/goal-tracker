...
final class AuthManager: ObservableObject {
    ...
    // Central place for API base URL used by auth and other requests
    // Keep in sync with HomeView if you override it there
    ...
    func attachAuth(to request: inout URLRequest) {
...
// Helper to decode dynamic values in user field
